...
if (__name__=='__main__'):
    ...
    if not repository_directory.exists():
        ...
        old_include_directory: Path = repository_directory/'include'
        shutil.move(old_include_directory/github_repo_name, repository_directory/'src')
        shutil.rmtree(old_include_directory)

    fmt_codebase = \
        CodeBase('Arithmetic',
                 repository_directory)
    
    fmt_codebase.generate_as_executable()
